...
class EditProductScreen extends StatefulWidget {
  ...
  final String id, title,deteils, price, productCat, imageUrl;
...
class _EditProductScreenState extends State<EditProductScreen> {
  ...
  void initState() {
    ...
    _deteilsController=TextEditingController(text: widget.deteils);
        ...
        if (kIsWeb) /* if web */ {
          ...
          await ref.putData(webImage).whenComplete(() async {
            ...
            await FirebaseFirestore.instance
              ...
              'deteils':_deteilsController.text,
                  ...
                  child: Form(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        TextFormField(
                           maxLines: 3,
                          controller: _deteilsController,
                          key: const ValueKey('deteils'),
                          validator: (value) {
                            if (value!.isEmpty) {
                              return 'Please enter a deteils';
                            }
                            return null;
                          },
                          decoration: inputDecoration,
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        TextWidget(text: 'DAY', color: color),
                                        Radio(
                                          value: 1,
                                          groupValue: val,
                                          onChanged: (value) {
                                        ...
                                        TextWidget(text: 'price', color: color),
                                        Radio(
                                          value: 2,
                                          groupValue: val,
                                          onChanged: (value) {
