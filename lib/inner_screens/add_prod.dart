...
import 'package:mangerpanel/controllers/MenuController.dart';
import 'package:mangerpanel/responsive.dart';
import 'package:mangerpanel/screens/loading_manager.dart';
...
import 'package:mangerpanel/widgets/side_menu.dart';
...
class _UploadProductFormState extends State<UploadProductForm> {
  ...
  void initState() {
    ...
    _detielsController = TextEditingController();
    ...
    if (isValid) {
      ...
      if (_pickedImage == null) {
        GlobalMethods.errorDialog(
            subtitle: 'please pick up image', context: context);
        return;
      }
      ...
      try {
        ...
        if (kIsWeb) /* if web */ {
          ...
          await ref.putData(webImage).whenComplete(() async {
            ...
            await FirebaseFirestore.instance
              ...
              'deteils':_detielsController.text,
        ...
        /*  firebase_storage.TaskSnapshot storageTaskSnapshot =
                  await firebase_storage.FirebaseStorage.instance
                      .ref()
                      .putFile(kIsWeb ? webImage : _pickedImage);
                      ...
                      child: Form(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            TextFormField(
                               maxLines: 3,
                              controller: _detielsController,
                              key: const ValueKey('detiels'),
                              validator: (value) {
                                if (value!.isEmpty) {
                                  return 'Please enter a detiels';
                                }
                                return null;
                              },
                              decoration: inputDecoration,
